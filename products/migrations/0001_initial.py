    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pvz', models.CharField(blank=True, max_length=200, null=True, verbose_name='Пункт выдачи')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_pay', models.CharField(blank=True, choices=[('online', 'Оплата онлайн'), ('cash', 'Оплата при получении')], max_length=70, null=True, verbose_name='Способ оплаты')),
